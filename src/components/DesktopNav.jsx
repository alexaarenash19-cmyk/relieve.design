  ...
  return (
    ...
    >
      <span className="flex flex-col transition-transform duration-400 ease-out group-hover:-translate-y-1/2">
        <span className="font-label uppercase tracking-wide text-xs text-brand-dark opacity-50">
          {children}
        </span>
        <span className="font-label uppercase tracking-wide text-xs text-brand-dark opacity-100">
          {children}
        </span>
      </span>
    </Tag>

...
// magic 0.995 scroll-progress threshold. This component — 3 static
// snapshots of the hero stages, stacked in normal document flow (no pin,
// no scrub), each just fading in as it's scrolled into view — was already
// the graceful-degradation path for touch/reduced-motion/narrow viewports
// (see old Home.jsx), so it's now simply *the* hero for everyone. Per
// ui-ux.md "versión por pasos con fades, sin coreografía".

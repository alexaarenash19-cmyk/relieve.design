...
//
// `type` doubles as the category (src/lib/categories.js) — one taxonomy,
// not a separate `collection` field. autodromo-hermanos-rodriguez and
// estadio-azteca are new placeholders added so every category (Ciudades,
// Estadios, F1, México, Montaña) has at least one real piece; their photos
// are representative stock (no exact-venue aerial shot was available on
// Unsplash), swap for real venue photos whenever they exist.
// Issue #65 — dropped `fm=jpg`: it was forcing plain JPEG on every request
// and silently overriding `auto=format`, which is what actually tells
// Unsplash's imgix backend to content-negotiate AVIF/WebP against the
// browser's Accept header. `auto=format` alone is enough; no `fm` needed.
...
export const DUMMY_PLACES = [
  ...
  },
  {
    ...
    lng: -99.0907,
    elevation_m: null,
    story: 'Sede del Gran Premio de México desde su regreso al calendario de F1 en 2015 — el Foro Sol convertido en la curva más ruidosa de la temporada.',
    aerial_url: null,
    model_url: null,
    thumb_url: img('1735636134481-1c6ef7f8df49'),
    base_price_cents: 129900,
    status: 'active',
  },
  {
    ...
    lng: -99.1505,
    elevation_m: null,
    story: 'El único estadio en haber albergado dos finales de Copa del Mundo — un coloso de concreto en el sur de la Ciudad de México.',
    aerial_url: null,
    model_url: null,
    thumb_url: img('1729008014101-d1df17135730'),
    base_price_cents: 129900,
    status: 'active',
  },
];
...
export const DUMMY_REVIEWS = [
  {
    ...
    photo_url: 'https://images.unsplash.com/photo-1769117549887-d7ab37279060?q=70&w=1200&auto=format&fit=crop',
  },
  {
    ...
    photo_url: 'https://images.unsplash.com/photo-1738682767944-d3c255abac3c?q=70&w=1200&auto=format&fit=crop',
  },
  {

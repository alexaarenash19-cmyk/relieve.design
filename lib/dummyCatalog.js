...
// regardless of this fallback. `series` values mirror
// 20260806020001_add_places_series.sql exactly, so /colecciones and
// /buscar keep working (not silently empty) during a Supabase outage.

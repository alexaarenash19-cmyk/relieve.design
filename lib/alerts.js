...
export async function sendCurvaDeNivelWelcome(email) {
  const html = `
    <div style="max-width:480px;margin:0 auto;font-family:Georgia,serif;color:#232323;background:#F6F3ED;padding:32px 28px;border:1px solid #DCD5C8;">
      ...
      <p style="margin-top:24px;"><a href="${SITE_URL}/colecciones" style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:0.06em;text-transform:uppercase;color:#22405C;">Ver el catálogo →</a></p>
    </div>`;

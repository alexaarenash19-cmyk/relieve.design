...
from (values
  ('autodromo-hermanos-rodriguez', 'Autódromo Hermanos Rodríguez', 'f1',      'MX', 19.404200, -99.090700, null),
  ('estadio-azteca',               'Estadio Azteca',               'estadio', 'MX', 19.302900, -99.150500, null)
